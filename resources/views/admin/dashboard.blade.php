                ...
                <div class="max-w-7xl mx-auto space-y-6 flex flex-col min-h-full justify-between">
                    ...
                    <div class="space-y-6 flex-grow">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div class="glass-card c-bg-3 p-6 rounded-[2rem] relative overflow-hidden animate-card delay-3 border">
                            ...
                            <div class="glass-card c-bg-4 p-6 rounded-[2rem] relative overflow-hidden sm:col-span-2 lg:col-span-1 animate-card delay-4 border">
